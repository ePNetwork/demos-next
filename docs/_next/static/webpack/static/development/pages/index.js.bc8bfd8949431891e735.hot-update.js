...
/* harmony import */ var tracking_url_util__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! tracking-url-util */ "./node_modules/tracking-url-util/dist/index.js");
/* harmony import */ var tracking_url_util__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(tracking_url_util__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./style.scss */ "./components/LinkGenForm/style.scss");
  ...
  function LinkGenForm(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "onSubmit", function (event) {
      ...
      _this.props.form.validateFieldsAndScroll(function (err, values) {
        ...
        if (!tracking_url_util__WEBPACK_IMPORTED_MODULE_13__["isProtocolPresent"](values.url)) {
          values.url = tracking_url_util__WEBPACK_IMPORTED_MODULE_13__["withProtocol"](values.url, tracking_url_util__WEBPACK_IMPORTED_MODULE_13__["Protocols"].HTTPS);
        }
      ...
      return __jsx("div", {
        ...
        rules: [{
          ...
          validator: function validator(_rule, value, cb) {
            var msg = 'Please enter a valid eBay domain';

            if (!value) {
              return cb(msg);
            }

            if (!tracking_url_util__WEBPACK_IMPORTED_MODULE_13__["isProtocolPresent"](value)) {
              value = tracking_url_util__WEBPACK_IMPORTED_MODULE_13__["withProtocol"](value, tracking_url_util__WEBPACK_IMPORTED_MODULE_13__["Protocols"].HTTPS);
            }

            if (!tracking_url_util__WEBPACK_IMPORTED_MODULE_13__["isValidProtocol"](value)) {
              return cb(msg);
            }
...
//# sourceMappingURL=index.js.bc8bfd8949431891e735.hot-update.js.map